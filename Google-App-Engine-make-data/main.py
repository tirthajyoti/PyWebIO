...
def interface():
    ...
    This is a **web app to relicate that function w/o writing any Python code**. 
    You can generate randomized dataset with labels `0` or `1` and download it on your local drive. Moreover, you can control,
    ...
    ## Instructions
    Just fill up the form below and hit **Submit**. 
    For repeated generation, just reload the page which will bring back this interface. Default values are provided in the form.  
    """, strip_indent=4)
...
app.add_url_rule('/', 'webio_view', webio_view(interface),
